...
set_property PACKAGE_PIN T1 [get_ports dest0[1]]
set_property IOSTANDARD LVCMOS33 [get_ports dest0[1]]


set_property PACKAGE_PIN U1 [get_ports dest0[0]]
set_property IOSTANDARD LVCMOS33 [get_ports dest0[0]]
...
set_property PACKAGE_PIN T3 [get_ports dest1[1]]
set_property IOSTANDARD LVCMOS33 [get_ports dest1[1]]


set_property PACKAGE_PIN V2 [get_ports dest1[0]]
set_property IOSTANDARD LVCMOS33 [get_ports dest1[0]]
...
set_property PACKAGE_PIN W15 [get_ports dest2[1]]
set_property IOSTANDARD LVCMOS33 [get_ports dest2[1]]


set_property PACKAGE_PIN W17 [get_ports dest2[0]]
set_property IOSTANDARD LVCMOS33 [get_ports dest2[0]]
...
set_property PACKAGE_PIN U16 [get_ports src[0]]
set_property IOSTANDARD LVCMOS33 [get_ports src[0]]

set_property PACKAGE_PIN E19 [get_ports src[1]]
