...
HD_PWD='/home/kgopal/Desktop/Prarthit/lab3/viv/project_4/project_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab3_reg_file.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab3_reg_file.tcl -notrace
