...
HD_PWD='/home/kgopal/Desktop/Prarthit/lab3/viv/project_4/project_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab3_reg_file.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab3_reg_file.tcl
